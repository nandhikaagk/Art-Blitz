...
<html lang="en">
	<head>
	    ...
	    <title>Art Blitz Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/art1.jpeg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Arts</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Paintings</a></li>
					<li><a href="#furniture" data-toggle="tab">Banaras</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-12">
	                   <section class="section">
	                   	<h3 class="section-title">Black And White </h3>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Banaras</h3>
